...
* For some sites a change of referer/user-agent is needed (do not block/hide by for example AdGuard's Tracking Protection extreme setting).
...
[WWD](https://wwd.com)\
*The Epoch Times* sites like (opt-in to custom sites for cz|de|fr|jp sites)\
...
*[BDU media](https://bdumedia.nl/nieuwsmerk)* sites (opt-in to custom sites)\
